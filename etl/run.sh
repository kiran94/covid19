...
python -m covid.ingest.timeseries -s load --source deaths

python -m covid.ingest.timeseries -s fetch --source confirmed
python -m covid.ingest.timeseries -s load --source confirmed

python -m covid.ingest.timeseries -s fetch --source recovered
python -m covid.ingest.timeseries -s load --source recovered
